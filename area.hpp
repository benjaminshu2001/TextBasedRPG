...
class Area{
	public: 
		...
		void fillMap() {
			...
			this->North->North->AddWestRoom(GobB, "B1", "You find yourself in a closet.", 4);
			this->North->North->AddNorthRoom(GobA, "A3", "You are in a hallway. To the west is a garden.", 0);
			this->North->North->North->AddWestRoom(0, "C1", " You find yourself in a garden.", 0);
			this->North->North->North->West->AddWestRoom(0, "C2", "You are in the middle of a field of chest-height grass.", 0);
			this->North->North->North->West->West->AddWestRoom(0, "C3", "In front of you lies an altar.", 3);		
			this->North->North->North->AddNorthRoom(GobC, "A4", "You are in a hallway. To the east is a large room.", 2);
			this->North->North->North->North->AddEastRoom(0, "D1", "You are in a large, empty, room.", 0);
			this->North->North->North->North->East->AddEastRoom(0, "D2", "You are at the back of the room.", 7);
			this->North->North->North->North->AddNorthRoom(GobB, "A5", "You are in a hallway.", 6);
			this->North->North->North->North->North->AddNorthRoom(0, "A6", "You are in a hallway. To the west is an unlocked door.", 0);
			this->North->North->North->North->North->North->AddWestRoom(GobB, "E1", "You are in a small storage room.", 5);
			this->North->North->North->North->North->North->AddNorthRoom(0, "A7", "You are in a hallway.", 0);
			this->North->North->North->North->North->North->North->AddNorthRoom(0, "A8", "You are in a hallway. To the west is a pile of filth.", 0);
			this->North->North->North->North->North->North->North->North->AddWestRoom(GobC, "F1", "You find yourself next to a pile of filth.", 3);
			this->North->North->North->North->North->North->North->North->AddEastRoom(0, "G1", "An empty closet.", 0);
